...
(function () {
    ...
    let hotel_TextureAtlasData: any;
    let hotel_TextureAtlas: createjs.SpriteSheet;

    let mansion_TextureAtlasData: any;
    let mansion_TextureAtlas: createjs.SpriteSheet;
    ...
    let bosses_TextureAtlasData: any;
    let bosses_TextureAtlas: createjs.SpriteSheet;
