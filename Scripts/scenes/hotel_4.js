...
(function (scenes) {
    var Hotel_4 = /** @class */ (function (_super) {
        ...
        Hotel_4.prototype.Start = function () {
            ...
            this.obstacles[0] = new objects.Gap(managers.Game.hotel_TextureAtlas, "Hole", new math.Vec2(115, 225));
            this.obstacles[1] = new objects.Gap(managers.Game.hotel_TextureAtlas, "Hole", new math.Vec2(450, 225));
            this.obstacles[2] = new objects.Gap(managers.Game.hotel_TextureAtlas, "Hole", new math.Vec2(115, 650));
            this.obstacles[3] = new objects.Gap(managers.Game.hotel_TextureAtlas, "Hole", new math.Vec2(450, 650));
            this.obstacles[4] = new objects.Barriers(managers.Game.hotel_TextureAtlas, "PotPlant");
            this.obstacles[4].SetPosition(new math.Vec2(200, 420));
            this.obstacles[5] = new objects.Barriers(managers.Game.hotel_TextureAtlas, "PotPlant");
