...
(function (scenes) {
    var Graveyard_6 = /** @class */ (function (_super) {
        ...
        function Graveyard_6() {
            var _this = _super.call(this, true, true, false, false, config.Design.GRAVEYARD) || this;
        ...
        Graveyard_6.prototype.Start = function () {
            ...
            this.enemies[2] = new objects.GhostThin(2, true, true);
            ...
            this.obstacles[8] = new objects.Barriers(managers.Game.graveyard_TextureAtlas, "GraveTile");
            this.obstacles[8].SetPosition(new math.Vec2(215, 320));
            this.obstacles[9] = new objects.Barriers(managers.Game.graveyard_TextureAtlas, "GraveTile");
            this.obstacles[9].SetPosition(new math.Vec2(265, 320));
            this.obstacles[10] = new objects.Barriers(managers.Game.graveyard_TextureAtlas, "GraveTile");
            this.obstacles[10].SetPosition(new math.Vec2(315, 320));
            this.obstacles[11] = new objects.Barriers(managers.Game.graveyard_TextureAtlas, "GraveTile");
            this.obstacles[11].SetPosition(new math.Vec2(450, 320));
            this.obstacles[12] = new objects.Gap(managers.Game.graveyard_TextureAtlas, "Hole", new math.Vec2(400, 505));
            this.obstacles[13] = new objects.Gap(managers.Game.graveyard_TextureAtlas, "Hole", new math.Vec2(350, 505));
            this.obstacles[14] = new objects.Gap(managers.Game.graveyard_TextureAtlas, "Hole", new math.Vec2(300, 505));
