module scenes {
    ...
    export class Graveyard_2 extends scenes.PlayScene {
        // Constructor
        constructor() {
            super(false, false, false, true,config.Design.GRAVEYARD);
            this.Start();
        }
        ...
        public Start(): void {
            ...
            this.enemies[4] = new objects.ShadowGhost(2, true, true);
            this.enemies[4].SetPosition(new math.Vec2(300, 130));
            this.enemies[5] = new objects.ShadowGhost(3, false, true);
