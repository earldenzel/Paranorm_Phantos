module scenes {
    ...
    export class Hotel_10 extends scenes.PlayScene { 
        ...
        public Start(): void {
            ...
            this.obstacles[4] = new objects.Barriers(managers.Game.hotel_TextureAtlas, "Hotel_CarpetTile");
            this.obstacles[4].SetPosition(new math.Vec2(200, 465));
            this.obstacles[5] = new objects.Barriers(managers.Game.hotel_TextureAtlas, "Hotel_CarpetTile");
            this.obstacles[5].SetPosition(new math.Vec2(200, 525));
            this.obstacles[6] = new objects.Barriers(managers.Game.hotel_TextureAtlas, "Hotel_CarpetTile");
            this.obstacles[6].SetPosition(new math.Vec2(360, 650));
            this.obstacles[7] = new objects.Barriers(managers.Game.hotel_TextureAtlas, "Hotel_CarpetTile");
            this.obstacles[7].SetPosition(new math.Vec2(360, 590));
            this.obstacles[8] = new objects.Barriers(managers.Game.hotel_TextureAtlas, "Hotel_CarpetTile");
            this.obstacles[8].SetPosition(new math.Vec2(360, 530));
            this.obstacles[9] = new objects.Barriers(managers.Game.hotel_TextureAtlas, "Hotel_CarpetTile");
            this.obstacles[9].SetPosition(new math.Vec2(360, 470));
            this.obstacles[10] = new objects.Barriers(managers.Game.hotel_TextureAtlas, "Hotel_CarpetTile");
            this.obstacles[10].SetPosition(new math.Vec2(360, 410));
            this.obstacles[11] = new objects.Barriers(managers.Game.hotel_TextureAtlas, "Hotel_CarpetTile");
