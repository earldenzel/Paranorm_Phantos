module managers{
    export class Chest{
        ...
        public Start():void {
            ...
            this.chestItems[1] = new objects.ChestItem("regularChest", "Items_Ten-Dollars", config.Effects.INCREASE_GOLD, config.Scene.GRAVEYARD_3, false);
            ...
            this.chestItems[3] = new objects.ChestItem("regularChest", "Items_Ten-Dollars", config.Effects.INCREASE_GOLD, config.Scene.GRAVEYARD_6);
            this.chestItems[3].SetPosition(new math.Vec2(400, 630));
            this.chestItems[4] = new objects.ChestItem("regularChest", "Items_Key", config.Effects.INCREASE_KEY_COUNT, config.Scene.HOTEL_2, false);
            this.chestItems[4].SetPosition(new math.Vec2(140, 630));
            this.chestItems[5] = new objects.ChestItem("regularChest", "Items_Key", config.Effects.INCREASE_KEY_COUNT, config.Scene.HOTEL_3, false);
            this.chestItems[5].SetPosition(new math.Vec2(285, 440));
            this.chestItems[6] = new objects.ChestItem("regularChest", "Items_Ten-Dollars", config.Effects.INCREASE_GOLD, config.Scene.HOTEL_4, false);
            this.chestItems[6].SetPosition(new math.Vec2(285, 630));
            this.chestItems[7] = new objects.ChestItem("regularChest", "Items_Key", config.Effects.INCREASE_KEY_COUNT, config.Scene.HOTEL_5, false);
            this.chestItems[7].SetPosition(new math.Vec2(385, 440));
            this.chestItems[8] = new objects.ChestItem("regularChest", "Items_Key", config.Effects.INCREASE_KEY_COUNT, config.Scene.HOTEL_6, false);
            this.chestItems[8].SetPosition(new math.Vec2(440, 150));
            this.chestItems[8] = new objects.ChestItem("chestWithGold", "Items_Ten-Dollars", config.Effects.INCREASE_GOLD_50, config.Scene.HOTEL_7, false);
            this.chestItems[8].SetPosition(new math.Vec2(385, 440));
            this.chestItems[9] = new objects.ChestItem("lockedChest", "Items_Fifty-Dollars", config.Effects.INCREASE_GOLD_50, config.Scene.GRAVEYARD_1);
            this.chestItems[9].SetPosition(new math.Vec2(185, 150));
            this.chestItems[9].locked = true;
            this.chestItems[10] = new objects.ChestItem("regularChest", "Items_Key", config.Effects.INCREASE_KEY_COUNT, config.Scene.GRAVEYARD_4, false);
            this.chestItems[10].SetPosition(new math.Vec2(250, 300));
            this.chestItems[11] = new objects.ChestItem("regularChest", "Items_Key", config.Effects.INCREASE_KEY_COUNT, config.Scene.GRAVEYARD_5, false);
            this.chestItems[11].SetPosition(new math.Vec2(250, 300));
            this.chestItems[12] = new objects.ChestItem("regularChest", "Items_Key", config.Effects.INCREASE_KEY_COUNT, config.Scene.GRAVEYARD_6, false);
